...
- GitLab Issue/MR operations, comments, or review (e.g. "Read Issue #7", "Review MR #N") → [`mr-review`](../mr-review/SKILL.md) (uses `gitlab_*` MCP tools served by the `gitlab-mcp` container)
